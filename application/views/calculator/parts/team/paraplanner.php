  ...
  <div class="col-md-12">
    <div class="table-responsive" style="overflow-x:auto;max-width:100%">
      <table id="advisers" class="table table-striped table-hover table-condensed table-bordered">
        <thead>
          <tr>
            <th><label>Paraplanners</label></th>
            <th colspan="6"><label>This covers anyone who is involved in the production of advice strategy and documentation.</label></th>
          </tr>
          <tr>
        ...
        <tbody id="paraplanner_list">
          <tr ng-repeat="data in team.paraplanner.datas track by $index" class="paraplanner_row">
          <td>
            ...
            <td class="text-center">
              <button ng-click="deleteTeam('paraplanner', $index)" type="button" class="btn btn-danger btn-xs delete_adviser text-center">
        ...
        <tfoot>
          <tr>
            <td>Total bonuses paid to Paraplanner staff</td>
            <td><input ng-model="other_datas.bonus_paid_paraplanner" class="text-right input_cell btn-block" type="text" data-format="$ 0,0[.]00" type="text" only-numeric /></td>
          </tr>
          <tr>
            <td>Other costs associated with the employment of paraplanner</td>
            <td><input ng-model="other_datas.other_cost_paraplanner" class="text-right input_cell btn-block" type="text" data-format="$ 0,0[.]00" type="text" only-numeric /></td>
          </tr>
          <tr>
            <td><label>TOTAL PARAPLANNER COSTS</label></td>
            <td><span class="text-right formula_cell btn-block">{{ totalTeamCost('paraplanner') }}</span></td>
           <!-- <td colspan="5">(includes 10% superannuation)</td> -->
          </tr>
          <tr>
            <td colspan="7">
              <button ng-click="addTeam('paraplanner')" type="button" class="btn btn-success btn-sm text-center">
