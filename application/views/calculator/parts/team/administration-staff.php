  ...
  <div class="col-md-12">
    <div class="table-responsive" style="overflow-x:auto;max-width:100%">
      <table id="advisers" class="table table-striped table-hover table-condensed table-bordered">
        <thead>
          <tr>
            <th><label>Client Service Offers</label></th>
            <th colspan="6"><label>This covers anyone who is provides adminstrative support directly related to providing advice to clients.</label></th>
          </tr>
          <tr>
        ...
        <tbody id="administration_staff_list">
          <tr ng-repeat="data in team.administration_staff.datas track by $index" class="administration_staff_row">
          <td>
            ...
            <td class="text-center">
              <button ng-click="deleteTeam('administration_staff', $index)" type="button" class="btn btn-danger btn-xs delete_adviser text-center">
        ...
        <tfoot>
          <tr>
            ...
            <td><input ng-model="other_datas.bonus_paid_administration_staff" class="text-right input_cell btn-block" type="text" data-format="$ 0,0[.]00" type="text" only-numeric /></td>
          </tr>
          <tr>
            <td>Other costs associated with the employment of Admin staff</td>
            <td><input ng-model="other_datas.other_cost_administration_staff" class="text-right input_cell btn-block" type="text" data-format="$ 0,0[.]00" type="text" only-numeric /></td>
          </tr>
          <tr>
            <td><label>TOTAL ADMINISTRATION STAFF COSTS</label></td>
            <td><span class="text-right formula_cell btn-block">{{ totalTeamCost('administration_staff') }}</span></td>
            <!-- <td colspan="5">(includes 10% superannuation)</td>-->
          </tr>
          <tr>
            <td colspan="7">
              <button ng-click="addTeam('administration_staff')" type="button" class="btn btn-success btn-sm text-center">
