...
<div class="page">
        <table style="width:100%;">
            ...
            <tr class="box">
                <td class="grid bold box " colspan="5"><label for="">test</label></td>
                <td class="grid center bold box " colspan="1"><label for=""><?php echo $count_d1 ?></label></td>
                <td class="grid center bold box " colspan="1"><label for=""><?php echo $count_d2 ?></label></td>
                <td class="grid center bold box " colspan="1"><label for="">&nbsp;</label></td>
                <td class="grid center bold box " colspan="1"><label for="">&nbsp;</label></td>
                <td class="grid center bold box " colspan="1"><label for="">&nbsp;</label></td>
                <td class="grid center bold box " colspan="1"><label for="">&nbsp;</label></td>
                <td class="grid center bold box " colspan="1"><label for="">&nbsp;</label></td>
            ...
            <tr>
                <td class="grid box" colspan="12">&nbsp;</td>
            </tr>
